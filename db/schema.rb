...
ActiveRecord::Schema[8.0].define(version: 2025_04_01_200354) do
  ...
  create_table "lessons", force: :cascade do |t|
    ...
    t.index ["lesson_type"], name: "index_lessons_on_lesson_type"
    t.index ["level"], name: "index_lessons_on_level"
  end
  ...
  create_table "media_resources", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["lesson_id"], name: "index_media_resources_on_lesson_id"
    t.index ["media_type"], name: "index_media_resources_on_media_type"
  end
  ...
  create_table "vocabulary_items", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["lesson_id"], name: "index_vocabulary_items_on_lesson_id"
    t.index ["word"], name: "index_vocabulary_items_on_word"
  end

  add_foreign_key "active_storage_variant_records", "active_storage_blobs", column: "blob_id"
  add_foreign_key "media_resources", "lessons"
  add_foreign_key "quizzes", "lessons"
  add_foreign_key "user_progresses", "lessons"
  add_foreign_key "user_progresses", "users"
  add_foreign_key "vocabulary_items", "lessons"
end
